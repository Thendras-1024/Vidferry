...
_CONTEXT_RECENT_TURNS = max(2, int(globals().get("AGENT_CONTEXT_RECENT_TURNS", 4) or 4))
_CONTEXT_RECENT_MESSAGES = _CONTEXT_RECENT_TURNS * 2
...
_CONTEXT_MODEL_WINDOW_TOKENS = max(4096, int(globals().get("AGENT_CONTEXT_MODEL_WINDOW_TOKENS", 1_000_000) or 1_000_000))
_CONTEXT_OUTPUT_MAX_TOKENS = max(128, int(globals().get("AGENT_CONTEXT_OUTPUT_MAX_TOKENS", 65_536) or 65_536))
_CONTEXT_INPUT_MAX_TOKENS = max(4096, int(globals().get("AGENT_CONTEXT_INPUT_MAX_TOKENS", _CONTEXT_MODEL_WINDOW_TOKENS - _CONTEXT_OUTPUT_MAX_TOKENS) or 934_464))
_CONTEXT_COMPACTION_TRIGGER_TOKENS = max(4096, int(globals().get("AGENT_CONTEXT_COMPACTION_TRIGGER_TOKENS", 850_000) or 850_000))
_CONTEXT_COMPACTION_RECOVERY_TOKENS = max(4096, int(globals().get("AGENT_CONTEXT_COMPACTION_RECOVERY_TOKENS", 650_000) or 650_000))
_CONTEXT_MAX_INPUT_TOKENS = _CONTEXT_INPUT_MAX_TOKENS
_CONTEXT_OUTPUT_RESERVE_TOKENS = _CONTEXT_OUTPUT_MAX_TOKENS
_CONTEXT_TOOL_RESULT_MAX_CHARS = max(500, int(globals().get("AGENT_CONTEXT_TOOL_RESULT_MAX_CHARS", 16_000) or 16_000))
_CONTEXT_TOOL_TOTAL_MAX_CHARS = max(1000, int(globals().get("AGENT_CONTEXT_TOOL_TOTAL_MAX_CHARS", 64_000) or 64_000))
_CONTEXT_POLICY_VERSION = "agent-context-v2"
_CONTEXT_PROMPT_OVERHEAD_TOKENS = 5000
...
class AgentContextBudgetError(ValueError):
    """最近完整回合本身超过模型可用上下文预算。"""
