...
MODULE_ORDER = [
    ...
    "app/core/youtube_retention_service.py",
    ...
    "app/core/agent_video_card_service.py",
    "app/core/agent_policy.py",
    "app/core/agent_copywriting_service.py",
    "app/core/agent_task_plan.py",
    "app/core/agent_tool_cards.py",
