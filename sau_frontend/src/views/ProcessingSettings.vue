        ...
        <section class="settings-section">
          ...
          <div class="settings-grid">
            ...
            <label class="setting-field settings-span-full">
              <span>翻译署名</span>
              <el-input v-model="form.translatorLabel" maxlength="20" show-word-limit :disabled="!form.translationEnabled" />
            </label>
          </div>
        </section>
      </el-tab-pane>
      ...
      <el-tab-pane label="翻译与拼接" name="assembly">
        <section class="settings-section">
          ...
          <div class="switch-list">
            <div class="switch-row"><div><strong>字幕处理与翻译</strong><span>关闭后不生成或烧制字幕。</span></div><el-switch v-model="form.translationEnabled" /></div>
...
const form = reactive({
  ...
  translationEnabled: true, highlightIntroEnabled: true, coverIntroEnabled: true, commentBurnEnabled: false,
